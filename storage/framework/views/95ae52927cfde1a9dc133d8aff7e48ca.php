<div class="sidebar d-flex flex-column" style="min-height: 100vh; background: #1a1a2e; color: #fff; width: 260px;">
    ...
    <nav class="nav flex-column mt-3 flex-grow-1">
        <a class="nav-link <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>" 
           href="/dashboard"
           style="color: #a2a2c2; padding: 12px 20px; transition: 0.3s; <?php echo e(request()->is('dashboard') ? 'color:#fff; background:rgba(255,255,255,0.1); border-left:4px solid #818cf8;' : ''); ?>">
            <i class="fas fa-home me-2"></i> Dashboard
        </a>
        <a class="nav-link <?php echo e(request()->is('pengaduan') ? 'active' : ''); ?>" 
           href="/pengaduan"
           style="color: #a2a2c2; padding: 12px 20px; transition: 0.3s; <?php echo e(request()->is('pengaduan') ? 'color:#fff; background:rgba(255,255,255,0.1); border-left:4px solid #818cf8;' : ''); ?>">
        ...
        <a class="nav-link <?php echo e(request()->is('pengaduan/saya') ? 'active' : ''); ?>" 
           href="/pengaduan/saya"
           style="color: #a2a2c2; padding: 12px 20px; transition: 0.3s; <?php echo e(request()->is('pengaduan/saya') ? 'color:#fff; background:rgba(255,255,255,0.1); border-left:4px solid #818cf8;' : ''); ?>">
