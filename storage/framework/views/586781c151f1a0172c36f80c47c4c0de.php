...
<div class="d-flex">
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-0">Selamat Datang, <?php echo e(Auth::user()->name); ?>!</h3>
                ...
                <div class="card stat-card shadow-sm p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold mb-0"><?php echo e($total); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card stat-card shadow-sm p-3">
                    <div class="d-flex align-items-center text-warning">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold mb-0"><?php echo e($pending); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\projectmagang\resources\views/dashboard.blade.php ENDPATH**/ ?>