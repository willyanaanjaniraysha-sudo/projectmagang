...
<div class="d-flex">
    ...
    <div class="main-content" style="max-width: 600px;">
        <div class="d-flex align-items-center gap-3 mb-4">
            <a href="<?php echo e(route('admin.index')); ?>" class="btn btn-sm btn-secondary rounded-3">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h4 class="fw-bold mb-0"><i class="fas fa-user-plus me-2 text-primary"></i>Tambah Admin</h4>
        </div>
            ...
            <form action="<?php echo e(route('admin.store')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control"
                           value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama admin">
                </div>
                <div class="mb-4">
...
</html><?php /**PATH C:\xampp\htdocs\projectmagang\resources\views/admin/create.blade.php ENDPATH**/ ?>