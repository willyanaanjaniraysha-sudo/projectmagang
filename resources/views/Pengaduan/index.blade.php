...
@section('content')
    <style>
        .pengaduan-page * { box-sizing: border-box; }

        .pengaduan-page {
            font-family: Arial;
        }

        .pengaduan-page .top-bar {
            display: flex;
            align-items: center;
            gap: 12px;
            margin-bottom: 24px;
        ...
        .pengaduan-page .list { display: flex; flex-direction: column; gap: 16px; }
        ...
        .pengaduan-page .card-body h3 {
            font-size: 18px;
            color: #1e293b;
            margin: 0;
        }

        .pengaduan-page .card-body p {
            font-size: 14px;
            color: #64748b;
            margin: 4px 0 8px 0;
            line-height: 1.5;
        ...
        .pengaduan-page .meta-info {
            display: flex;
            align-items: center;
            gap: 12px;
        }

        .pengaduan-page .badge {
        ...
        .pengaduan-page .badge-pending   { background: #fef9c3; color: #854d0e; }
        .pengaduan-page .badge-diproses  { background: #dbeafe; color: #1e40af; }
        .pengaduan-page .badge-disposisi { background: #ede9fe; color: #5b21b6; }
        .pengaduan-page .badge-selesai   { background: #d1fae5; color: #065f46; }

        .pengaduan-page .tanggal {
            font-size: 12px;
            color: #94a3b8;
        }

        .pengaduan-page .empty {
            text-align: center;
            color: #94a3b8;
            padding: 40px;
            font-size: 15px;
